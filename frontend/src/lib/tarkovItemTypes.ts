...
export const TARKOV_HANDBOOK_ROOTS: TarkovHandbookRoot[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: "5b47574386f77428ca22b331", order: 110, label: "眼部装备" },
      { id: "5b47574386f77428ca22b32f", order: 120, label: "面部装备" },
      { id: "5b5f6f8786f77447ed563642", order: 130, label: "战术胸挂" },
      { id: "5b5f701386f774093f2ecf0f", order: 140, label: "防弹衣" },
      { id: "5b5f6f3c86f774094242ef87", order: 150, label: "耳机" },
      { id: "5b5f6f6c86f774093f2ecf0b", order: 160, label: "背包" },
      { id: "5b5f6fa186f77409407a7eb7", order: 170, label: "容器" },
      { id: "5b5f6fd286f774093f2ecf0d", order: 180, label: "安全箱" },
      { id: "5b5f704686f77447ec5d76d7", order: 190, label: "装备组件" },
    ],
  },
  {
