...
export function KujiequAttendanceCalendarButton({
  ...
  const queryKey = ["kujiequ-attendance-calendar", gameCode, roleUid];

  const query = useQuery({
    queryKey,
    queryFn: () => fetchKujiequAttendanceCalendar(gameCode, roleUid, false),
  ...
  const onRefresh = async () => {
    setRefreshing(true);
    try {
      const data = await fetchKujiequAttendanceCalendar(gameCode, roleUid, true);
